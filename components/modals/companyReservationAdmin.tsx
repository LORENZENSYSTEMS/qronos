...
export default function CompanyReservationAdmin({ visible, onClose, empresaId }: CompanyReservationAdminProps) {
    ...
    const [horaReserva, setHoraReserva] = useState('18:00');
                        ...
                        <View style={styles.cardForm}>
                            ...
                            >
                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    <Text style={styles.timeDropdownText}>{horaReserva} Hrs</Text>
                                </View>
                            ...
                            {isTimeDropdownOpen && (
                                <View style={styles.timeDropdownGrid}>
                                    {MILITARY_TIMES.map((time) => (
                                        <TouchableOpacity
                                            key={time}
                                            style={[styles.timeOptionItem, horaReserva === time && styles.timeOptionItemActive]}
                                            onPress={() => {
                                                setHoraReserva(time);
                                                setIsTimeDropdownOpen(false);
                                            }}
                                        >
                                            <Text style={[styles.timeOptionText, horaReserva === time && styles.timeOptionTextActive]}>{time}</Text>
                                        </TouchableOpacity>
                                    ))}
                                </View>
                            )}
